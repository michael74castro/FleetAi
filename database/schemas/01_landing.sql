...
CREATE TABLE [landing].[CCCA] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCCA_CACANO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACADS] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACADR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAOB_Object_Number] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACABC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACABY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACABM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACABD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAEC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAEY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAEM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAED] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACARC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACARY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACARM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACARD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CARRCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACASC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CARPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACOUC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CALIDI] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACATY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACARP] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCA_CACAOC] AS VARCHAR(MAX)), ''))) PERSISTED,
    ...
    [CCCA_CACAOB_Object_Number] INT NULL,
...
CREATE TABLE [landing].[CCDT] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCDT_DTCYCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCDT_DTDMID] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCDT_DTDMVA] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCDT_DTDMLN] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCDT_DTDMTX] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (5 columns with CCDT_ prefix)
    [CCDT_DTCYCD] VARCHAR(10) NULL,
    [CCDT_DTDMID] INT NULL,
    [CCDT_DTDMVA] VARCHAR(50) NULL,
    [CCDT_DTDMLN] VARCHAR(10) NULL,
    [CCDT_DTDMTX] VARCHAR(200) NULL,
...
CREATE INDEX [IX_landing_CCDT_hash] ON [landing].[CCDT]([row_hash]);
GO
...
CREATE TABLE [landing].[CCES] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCES_ESCUNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESPCNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESOBNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESESSQ] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESESCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESESCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESESIV] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESIVSU] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESTMCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESTMIV] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESLPCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESRPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESCOUC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESVOLC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESDISC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESCONC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCES_ESCURC] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (17 columns with CCES_ prefix)
    [CCES_ESCUNO] INT NULL,
    [CCES_ESPCNO] INT NULL,
    [CCES_ESOBNO] INT NULL,
    [CCES_ESESSQ] INT NULL,
    [CCES_ESESCD] INT NULL,
    [CCES_ESESCT] DECIMAL(15,2) NULL,
    [CCES_ESESIV] DECIMAL(15,2) NULL,
    [CCES_ESIVSU] DECIMAL(15,2) NULL,
    [CCES_ESTMCT] DECIMAL(15,2) NULL,
    [CCES_ESTMIV] DECIMAL(15,2) NULL,
    [CCES_ESLPCD] VARCHAR(10) NULL,
    [CCES_ESRPPD] INT NULL,
    [CCES_ESCOUC] VARCHAR(10) NULL,
    [CCES_ESVOLC] VARCHAR(10) NULL,
    [CCES_ESDISC] VARCHAR(10) NULL,
    [CCES_ESCONC] VARCHAR(10) NULL,
    [CCES_ESCURC] VARCHAR(10) NULL,
...
CREATE INDEX [IX_landing_CCES_hash] ON [landing].[CCES]([row_hash]);
GO
...
CREATE TABLE [landing].[CCMS] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCMS_MSOBNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDSQ] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDCC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDYY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDMM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDDD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDKM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDAM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDDS] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDD2] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDD3] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSGDSC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSMSTY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSNUFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSNAFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSMJCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSMNCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSRPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSCOUC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSVOLC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSDISC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSCONC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSCURC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSSIRN] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSDAFC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSDAFY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSDAFM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCMS_MSDAFD] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (28 columns with CCMS_ prefix)
    [CCMS_MSOBNO] INT NULL,
    [CCMS_MSGDSQ] INT NULL,
    [CCMS_MSGDCC] INT NULL,
    [CCMS_MSGDYY] INT NULL,
    [CCMS_MSGDMM] INT NULL,
    [CCMS_MSGDDD] INT NULL,
    [CCMS_MSGDKM] DECIMAL(15,2) NULL,
    [CCMS_MSGDAM] DECIMAL(15,2) NULL,
    [CCMS_MSGDDS] VARCHAR(200) NULL,
    [CCMS_MSGDD2] VARCHAR(200) NULL,
    [CCMS_MSGDD3] VARCHAR(200) NULL,
    [CCMS_MSGDSC] VARCHAR(10) NULL,
    [CCMS_MSMSTY] INT NULL,
    [CCMS_MSNUFO] INT NULL,
    [CCMS_MSNAFO] VARCHAR(50) NULL,
    [CCMS_MSMJCD] VARCHAR(10) NULL,
    [CCMS_MSMNCD] VARCHAR(10) NULL,
    [CCMS_MSRPPD] INT NULL,
    [CCMS_MSCOUC] VARCHAR(10) NULL,
    [CCMS_MSVOLC] VARCHAR(10) NULL,
    [CCMS_MSDISC] VARCHAR(10) NULL,
    [CCMS_MSCONC] VARCHAR(10) NULL,
    [CCMS_MSCURC] VARCHAR(10) NULL,
    [CCMS_MSSIRN] INT NULL,
    [CCMS_MSDAFC] INT NULL,
    [CCMS_MSDAFY] INT NULL,
    [CCMS_MSDAFM] INT NULL,
    [CCMS_MSDAFD] INT NULL,
...
CREATE INDEX [IX_landing_CCMS_hash] ON [landing].[CCMS]([row_hash]);
GO
...
CREATE TABLE [landing].[CCPI] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCPI_PICONO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PICUNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PINACD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIOBNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPCNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIAM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPICD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIEBRP] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIDR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIDS] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIGR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIIV] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPILP] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIOB] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIOR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIRN] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPISC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIPIVT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PIRPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCPI_PICOUC] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (20 columns with CCPI_ prefix)
    [CCPI_PICONO] INT NULL,
    [CCPI_PICUNO] INT NULL,
    [CCPI_PINACD] VARCHAR(50) NULL,
    [CCPI_PIOBNO] INT NULL,
    [CCPI_PIPCNO] INT NULL,
    [CCPI_PIPIAM] DECIMAL(15,2) NULL,
    [CCPI_PIPICD] DECIMAL(15,2) NULL,
    [CCPI_PIEBRP] DECIMAL(15,2) NULL,
    [CCPI_PIPIDR] DECIMAL(15,2) NULL,
    [CCPI_PIPIDS] VARCHAR(200) NULL,
    [CCPI_PIPIGR] VARCHAR(10) NULL,
    [CCPI_PIPIIV] DECIMAL(15,2) NULL,
    [CCPI_PIPILP] VARCHAR(10) NULL,
    [CCPI_PIPIOB] DECIMAL(15,2) NULL,
    [CCPI_PIPIOR] VARCHAR(10) NULL,
    [CCPI_PIPIRN] DECIMAL(15,2) NULL,
    [CCPI_PIPISC] VARCHAR(10) NULL,
    [CCPI_PIPIVT] VARCHAR(10) NULL,
    [CCPI_PIRPPD] INT NULL,
    [CCPI_PICOUC] VARCHAR(10) NULL,
...
CREATE INDEX [IX_landing_CCPI_hash] ON [landing].[CCPI]([row_hash]);
GO
...
CREATE TABLE [landing].[CCRC] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCRC_RCOBNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCSQ] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCDRNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCRN] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCBC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCBY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCBM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCBD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCEC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCEY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCEM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCED] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCCD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCKM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCAM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCRS] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCDS] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCD2] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCD3] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCTY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCDR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRCSC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCRPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRC_RCCOUC] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (25 columns with CCRC_ prefix)
    [CCRC_RCOBNO] INT NULL,
    [CCRC_RCRCNO] INT NULL,
    [CCRC_RCRCSQ] VARCHAR(10) NULL,
    [CCRC_RCDRNO] DECIMAL(15,2) NULL,
    [CCRC_RCRCRN] DECIMAL(15,2) NULL,
    [CCRC_RCRCBC] INT NULL,
    [CCRC_RCRCBY] INT NULL,
    [CCRC_RCRCBM] INT NULL,
    [CCRC_RCRCBD] INT NULL,
    [CCRC_RCRCEC] INT NULL,
    [CCRC_RCRCEY] INT NULL,
    [CCRC_RCRCEM] INT NULL,
    [CCRC_RCRCED] INT NULL,
    [CCRC_RCRCCD] VARCHAR(10) NULL,
    [CCRC_RCRCKM] DECIMAL(15,2) NULL,
    [CCRC_RCRCAM] DECIMAL(15,2) NULL,
    [CCRC_RCRCRS] VARCHAR(200) NULL,
    [CCRC_RCRCDS] VARCHAR(200) NULL,
    [CCRC_RCRCD2] VARCHAR(200) NULL,
    [CCRC_RCRCD3] VARCHAR(200) NULL,
    [CCRC_RCRCTY] VARCHAR(10) NULL,
    [CCRC_RCRCDR] VARCHAR(100) NULL,
    [CCRC_RCRCSC] VARCHAR(10) NULL,
    [CCRC_RCRPPD] INT NULL,
    [CCRC_RCCOUC] VARCHAR(10) NULL,
...
CREATE INDEX [IX_landing_CCRC_hash] ON [landing].[CCRC]([row_hash]);
GO
...
CREATE TABLE [landing].[CCRP] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCRP_RPRPCC] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRP_RPRPYY] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRP_RPRPMM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRP_RPRPDD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRP_RPRPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCRP_RPMTPD] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (6 columns with CCRP_ prefix)
    [CCRP_RPRPCC] DECIMAL(15,2) NULL,
    [CCRP_RPRPYY] DECIMAL(15,2) NULL,
    [CCRP_RPRPMM] DECIMAL(15,2) NULL,
    [CCRP_RPRPDD] DECIMAL(15,2) NULL,
    [CCRP_RPRPPD] DECIMAL(15,2) NULL,
    [CCRP_RPMTPD] DECIMAL(15,2) NULL,
...
CREATE INDEX [IX_landing_CCRP_hash] ON [landing].[CCRP]([row_hash]);
GO
...
CREATE TABLE [landing].[CCSU] (
    ...
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCSU_SUNUFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNAFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNOFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNOF2] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNOF3] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUCLFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUCPFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUADFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SULOFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUCAFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNTFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNFFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUNEFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUCTFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SURSFO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SURPPD] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCSU_SUCOUC] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (17 columns with CCSU_ prefix)
    [CCSU_SUNUFO] INT NULL,
    [CCSU_SUNAFO] VARCHAR(50) NULL,
    [CCSU_SUNOFO] VARCHAR(200) NULL,
    [CCSU_SUNOF2] VARCHAR(200) NULL,
    [CCSU_SUNOF3] VARCHAR(200) NULL,
    [CCSU_SUCLFO] VARCHAR(10) NULL,
    [CCSU_SUCPFO] VARCHAR(10) NULL,
    [CCSU_SUADFO] VARCHAR(200) NULL,
    [CCSU_SULOFO] VARCHAR(100) NULL,
    [CCSU_SUCAFO] VARCHAR(50) NULL,
    [CCSU_SUNTFO] VARCHAR(50) NULL,
    [CCSU_SUNFFO] VARCHAR(50) NULL,
    [CCSU_SUNEFO] VARCHAR(100) NULL,
    [CCSU_SUCTFO] VARCHAR(100) NULL,
    [CCSU_SURSFO] VARCHAR(100) NULL,
    [CCSU_SURPPD] DECIMAL(15,2) NULL,
    [CCSU_SUCOUC] VARCHAR(10) NULL,
...
CREATE INDEX [IX_landing_CCSU_hash] ON [landing].[CCSU]([row_hash]);
GO

-- Table: CCCR
-- Source: cccr_1.xlsx..cccr_10.xlsx
-- Columns: 102
CREATE TABLE [landing].[CCCR] (
    -- Metadata columns for CDC
    [extraction_id] BIGINT IDENTITY(1,1),
    [extraction_timestamp] DATETIME2 DEFAULT GETUTCDATE(),
    [row_hash] AS HASHBYTES('SHA2_256', CONCAT_WS('|', COALESCE(CAST([CCCR_CROBNO] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRFUCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRMACT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRRCCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRTRCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRTOCT] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRTOIV] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRFSKM] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRKMDR] AS VARCHAR(MAX)), ''), COALESCE(CAST([CCCR_CRRPPD] AS VARCHAR(MAX)), ''))) PERSISTED,

    -- Source columns (102 columns with CCCR_ prefix)
    [CCCR_CROBNO] INT NULL,
    [CCCR_CRBEAM] DECIMAL(15,2) NULL,
    [CCCR_CRBELT] DECIMAL(15,2) NULL,
    [CCCR_CRDIAM] DECIMAL(15,2) NULL,
    [CCCR_CRDILT] DECIMAL(15,2) NULL,
    [CCCR_CRGAAM] DECIMAL(15,2) NULL,
    [CCCR_CRGALT] DECIMAL(15,2) NULL,
    [CCCR_CRFSBV] DECIMAL(15,2) NULL,
    [CCCR_CRFSIR] DECIMAL(15,4) NULL,
    [CCCR_CRFUCT] DECIMAL(15,2) NULL,
    [CCCR_CRMACT] DECIMAL(15,2) NULL,
    [CCCR_CRRCCT] DECIMAL(15,2) NULL,
    [CCCR_CRTRCT] DECIMAL(15,2) NULL,
    [CCCR_CRFUIV] DECIMAL(15,2) NULL,
    [CCCR_CRMAIV] DECIMAL(15,2) NULL,
    [CCCR_CRRCIV] DECIMAL(15,2) NULL,
    [CCCR_CRTRIV] DECIMAL(15,2) NULL,
    [CCCR_CRFSKM] INT NULL,
    [CCCR_CRKMCC] INT NULL,
    [CCCR_CRKMYY] INT NULL,
    [CCCR_CRKMMM] INT NULL,
    [CCCR_CRKMDD] INT NULL,
    [CCCR_CRFSIK] INT NULL,
    [CCCR_CRKMDR] DECIMAL(15,2) NULL,
    [CCCR_CRMMDR] DECIMAL(15,2) NULL,
    [CCCR_CRKMTE] DECIMAL(15,2) NULL,
    [CCCR_CRFUCK] DECIMAL(15,4) NULL,
    [CCCR_CRFUIK] DECIMAL(15,4) NULL,
    [CCCR_CRRECO] DECIMAL(15,4) NULL,
    [CCCR_CRFUSL] DECIMAL(15,4) NULL,
    [CCCR_CRFUMD] DECIMAL(15,4) NULL,
    [CCCR_CRMACK] DECIMAL(15,4) NULL,
    [CCCR_CRMAIK] DECIMAL(15,4) NULL,
    [CCCR_CRMASL] DECIMAL(15,4) NULL,
    [CCCR_CRMAMD] DECIMAL(15,4) NULL,
    [CCCR_CRRCCK] DECIMAL(15,4) NULL,
    [CCCR_CRRCIK] DECIMAL(15,4) NULL,
    [CCCR_CRRCSL] DECIMAL(15,4) NULL,
    [CCCR_CRRCMD] DECIMAL(15,4) NULL,
    [CCCR_CRRCKM] DECIMAL(15,2) NULL,
    [CCCR_CRRCAM] DECIMAL(15,2) NULL,
    [CCCR_CRTRCK] DECIMAL(15,4) NULL,
    [CCCR_CRTRIK] DECIMAL(15,4) NULL,
    [CCCR_CRTRSL] DECIMAL(15,4) NULL,
    [CCCR_CRTRMD] DECIMAL(15,4) NULL,
    [CCCR_CRTOCT] DECIMAL(15,2) NULL,
    [CCCR_CRTOIV] DECIMAL(15,2) NULL,
    [CCCR_CRCTKM] DECIMAL(15,4) NULL,
    [CCCR_CRTOSU] DECIMAL(15,2) NULL,
    [CCCR_CRTOSA] DECIMAL(15,2) NULL,
    [CCCR_CRTOTO] DECIMAL(15,2) NULL,
    [CCCR_CRLWKM] DECIMAL(15,2) NULL,
    [CCCR_CRUPKM] DECIMAL(15,2) NULL,
    [CCCR_CRMANR] INT NULL,
    [CCCR_CRFUNR] INT NULL,
    [CCCR_CRRCNR] INT NULL,
    [CCCR_CRTRNR] INT NULL,
    [CCCR_CRTNNR] INT NULL,
    [CCCR_CRTWNR] INT NULL,
    [CCCR_CRPRKT] DECIMAL(15,4) NULL,
    [CCCR_CRDANB] INT NULL,
    [CCCR_CRDARE] DECIMAL(15,2) NULL,
    [CCCR_CRSG01] DECIMAL(15,2) NULL,
    [CCCR_CRSG02] DECIMAL(15,2) NULL,
    [CCCR_CRSG03] DECIMAL(15,2) NULL,
    [CCCR_CRSG04] DECIMAL(15,2) NULL,
    [CCCR_CRSG05] DECIMAL(15,2) NULL,
    [CCCR_CRSG06] DECIMAL(15,2) NULL,
    [CCCR_CRSG07] DECIMAL(15,2) NULL,
    [CCCR_CRSG08] DECIMAL(15,2) NULL,
    [CCCR_CRSG09] DECIMAL(15,2) NULL,
    [CCCR_CRSG10] DECIMAL(15,2) NULL,
    [CCCR_CRSG11] DECIMAL(15,2) NULL,
    [CCCR_CRSG12] DECIMAL(15,2) NULL,
    [CCCR_CRSG13] DECIMAL(15,2) NULL,
    [CCCR_CRSG14] DECIMAL(15,2) NULL,
    [CCCR_CRSG15] DECIMAL(15,2) NULL,
    [CCCR_CRRPPD] INT NULL,
    [CCCR_CRCOUC] VARCHAR(10) NULL,
    [CCCR_CRVOLC] VARCHAR(10) NULL,
    [CCCR_CRDISC] VARCHAR(10) NULL,
    [CCCR_CRCONC] VARCHAR(10) NULL,
    [CCCR_CRCURC] VARCHAR(10) NULL,
    [CCCR_CRMIAM] DECIMAL(15,2) NULL,
    [CCCR_CRMIPY] DECIMAL(15,2) NULL,
    [CCCR_CRMIRN] DECIMAL(15,2) NULL,
    [CCCR_CRTSAM] DECIMAL(15,2) NULL,
    [CCCR_CRTSPY] DECIMAL(15,2) NULL,
    [CCCR_CRTSRN] DECIMAL(15,2) NULL,
    [CCCR_CRTRNO] INT NULL,
    [CCCR_CRPACT] DECIMAL(15,2) NULL,
    [CCCR_CRPAIV] DECIMAL(15,2) NULL,
    [CCCR_CRPAMD] DECIMAL(15,4) NULL,
    [CCCR_CRPASL] DECIMAL(15,4) NULL,
    [CCCR_CRUNCT] DECIMAL(15,2) NULL,
    [CCCR_CRUNIV] DECIMAL(15,2) NULL,
    [CCCR_CRUNMD] DECIMAL(15,4) NULL,
    [CCCR_CRUNSL] DECIMAL(15,4) NULL,
    [CCCR_CRWACT] DECIMAL(15,2) NULL,
    [CCCR_CRWAIV] DECIMAL(15,2) NULL,
    [CCCR_CRWAMD] DECIMAL(15,4) NULL,
    [CCCR_CRWASL] DECIMAL(15,4) NULL,
...
CREATE INDEX [IX_landing_CCCR_hash] ON [landing].[CCCR]([row_hash]);
GO
