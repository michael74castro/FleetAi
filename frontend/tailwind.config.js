...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        // LeasePlan/MyFleet Brand Colors
        brand: {
          orange: '#F06400',
          'orange-light': '#FF7A1A',
          'orange-dark': '#D45800',
      ...
      boxShadow: {
        'glass': '0 8px 32px 0 rgba(0, 73, 93, 0.15)',
        'glass-lg': '0 16px 48px 0 rgba(0, 73, 93, 0.2)',
        'glass-inset': 'inset 0 1px 1px 0 rgba(255, 255, 255, 0.1)',
        'glow-orange': '0 0 40px rgba(240, 100, 0, 0.3)',
        'glow-orange-intense': '0 0 50px rgba(240, 100, 0, 0.5)',
        'glow-cyan': '0 0 40px rgba(0, 177, 175, 0.3)',
      },
      backgroundImage: {
